...
To increase the reusability and reproducibility of scientific findings,
...
Based on _ShinyCell_, The _scRNAseqApp_ package is developed with multiple
...
```{r, eval=FALSE}
library(BiocManager)
BiocManager::install("jianhong/scRNAseqApp@dev")
```
