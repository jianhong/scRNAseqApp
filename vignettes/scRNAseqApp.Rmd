...
[^2]: the package contribute paritial to the citation
...
Note: the following files need to be writable for shiny: `database.sqlite`,
`www/counter.tsv` and the app folder should also be writable because the 
